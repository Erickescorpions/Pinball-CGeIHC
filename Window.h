...
public:
	...
	bool getInterruptorFlippers() { return interruptorFlippers; }
	bool getInterruptorSantuario() { return interruptorSantuario; }
	bool getShouldClose() {
...
private: 
	...
	bool interruptorFlippers = false, interruptorSantuario = false;
